...
title: 'Telegram bot'
date: '2023-07-20'
tags: ['python', 'telegram', 'bot', 'web scraping', 'scraping', 'json']
---
...
a message to a Telegram group. And during the lazy perios of time, it sleeps for a different ammount of time depending on
