...
date: '2022-12-10'
tags: ['vue.js', 'vuejs','flask','javascript', 'typescript','python', 'bootstrap', 'jinja', 'web development', 'css3', 'posgresql', 'sql', 'html5', 'git', 'gitHub', 'w3c', 'responsive', responsiveness']
---
