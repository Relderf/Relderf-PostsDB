...
date: '2023-07-18'
tags: ['vue.js', 'vuejs','flask','javascript', 'typescript','python','web development', 'css3', 'posgresql', 'sql', 'html5', 'bootstrap', 'jinja', 'git', 'gitHub', 'w3c', 'responsive', responsiveness']
---
